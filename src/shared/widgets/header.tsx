...
const Header = () => {
  return (
    <div className=" flex justify-between items-center px-10 py-3  shadow-slate-200 dark:shadow-none border-b-2  poppins-medium ">
      <div className="scroll-m-20   w-full font-bold  pb-2 text-3xl  tracking-tight first:mt-0">
        <Image src={logoDark} className=" h-7  w-44 dark:hidden block" alt="" />
        <Image src={logo} className=" h-7  w-44 dark:block hidden " alt="" />
      </div>
